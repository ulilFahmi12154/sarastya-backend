...
public sealed class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Project>(entity =>
        {
            ...
            entity.Property(p => p.StartDate).HasColumnName("start_date").HasColumnType("timestamp without time zone");
            entity.Property(p => p.EndDate).HasColumnName("end_date").HasColumnType("timestamp without time zone");
        ...
        modelBuilder.Entity<TaskEntity>(entity =>
        {
            ...
            entity.Property(t => t.Content).HasColumnName("content").HasMaxLength(2000);
            entity.Property(t => t.Status)
                .HasColumnName("status")
                .HasConversion<string>()
                .HasMaxLength(20);
            entity.Property(t => t.Priority).HasColumnName("priority");
            entity.Property(t => t.DueDate).HasColumnName("due_date").HasColumnType("timestamp without time zone");
        });
